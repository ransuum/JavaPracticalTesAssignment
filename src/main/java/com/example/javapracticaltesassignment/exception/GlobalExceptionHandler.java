...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(LessThanMinAgeException.class)
    public ResponseEntity<String> handleLessThanMinAgeException(LessThanMinAgeException ex) {
        return ResponseEntity.status(HttpStatus.NOT_ACCEPTABLE).body(ex.getMessage());
    }
    @ExceptionHandler(DateBiggerThanToday.class)
    public ResponseEntity<String> handleDateBiggerThanToday(DateBiggerThanToday ex) {
